...
export default function Register() {
  const defaultQuestion: ISecurityQuestionDTO = new Securi
  ...
  const [question1, setQuestion1] = useState<ISecurityQuestionDTO>({
    questionId: -1,
    answer: "",
  });
  const [question2, setQuestion2] = useState<ISecurityQuestionDTO>({
    questionId: -1,
    answer: "",
  });
  const [question3, setQuestion3] = useState<ISecurityQuestionDTO>({
    questionId: -1,
    answer: "",
  });
