        ...
        <div className="formcontainer">
          ...
          <div className="mainform jc-space-b" style={{ height: "38em" }}>
            ...
            >
              ...
              <div className={(me.profilePicture && me.profilePicture.approvalDate == null ? " yellow-border":"")}></div>
              
            </div>
            {me.profilePicture && me.profilePicture.approvalDate == null && <div className="pfp-warning">Your profile picture is pending approval, until it is approved, only you can see it!</div>}
